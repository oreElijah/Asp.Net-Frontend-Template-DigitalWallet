...
namespace DigitalWalletApi.Controllers
{
    ...
    namespace DigitalWalletApi.Controllers
    {
        ...
        public class StudentController : ControllerBase
        {
            ...
            public StudentController(UserManager<AppUser> userManager, IAuthService authService, IWalletService walletService, IEmailService emailService, IWebHostEnvironment env, ILogger<StudentController> logger, IPaymentService paystackService)
            {
